            ...
            <div className="flex justify-between items-start">
              <div className="flex-1">
                ...
                <p className="text-gray-800 mt-1 text-md">
                  Full Stack Developer | MERN | PostgreSQL | Prisma | Hono |
                  Redis | TypeScript | AWS | Docker | REST APIs
                </p>
          ...
          <div className="px-8 py-6">
            <div className="bg-white rounded-lg">
              ...
              <p className="text-gray-700 whitespace-pre-line">
                ...
                applications. I love solving complex problems and creating
                elegant solutions. With a strong foundation in both frontend and
                backend technologies, I specialize in creating robust,
                user-friendly applications that deliver exceptional value to
                users.
              </p>
            </div>
          </div>
