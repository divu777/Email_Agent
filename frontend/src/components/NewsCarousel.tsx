...
export const newsData: NewsItem[] = [
  {
    ...
    excerpt:
      "Recent study shows AI-powered email management systems reduce response times by 300% while maintaining high accuracy.",
    source: "TechCrunch",
    date: "Mar 15, 2024",
    link: "#",
  },
  {
    ...
    excerpt:
      "Research indicates 78% of businesses plan to implement AI email automation by 2025.",
    source: "Forbes",
    date: "Mar 12, 2024",
    link: "#",
  },
  {
    ...
    excerpt:
      "Tech entrepreneur Divakar Jaiswal discusses how his team developed a revolutionary email automation system.",
  ...
  },
  {
    ...
    excerpt:
      "New research reveals significant productivity gains through AI-powered email management systems.",
  ...
  },
  {
    ...
    excerpt:
      "How modern AI systems are revolutionizing email management with context-aware responses.",
    source: "Wired",
    date: "Mar 5, 2024",
    link: "#",
  },
      ...
      <div className="h-full w-full px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Discover how AI-powered email automation is transforming business
            communication
          </p>
        </div>
          ...
          {Array.from({ length: newsData.length }).map((_, idx) => (
            <button
              ...
              className={`h-3 rounded-full transition-all duration-300 ${
                currentIndex % newsData.length === idx
                  ? "w-8 bg-gray-800"
                  : "w-3 bg-gray-300"
              }`}
